_53e‍.x([["default",()=>Game]]);class Game{
    //size: the number of tiles in one row
    constructor(size) {
        this.size = size;
        //
        this.rowNum =size;
        this.eleNum = size*size;
     ...
     */
    getGameState() {
        console.log(this.gameState, "here");
    ...
    move(direction) {
        ...
        switch (direction) {
            ...
            case 'down':
                ...
                for (let j = this.boardSize - 1; j >= this.eleNum - this.size; j--) {
                    let i = j;
        ...
        this.gameState.board = this.newTile(this.gameState.board);

        if (this.checkWon()) {
            this.gameState.won = true;
            console.log(this.gameState.won);
        }
        if (this.checkOver()) {
