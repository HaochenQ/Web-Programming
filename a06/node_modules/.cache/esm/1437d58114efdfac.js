let heroData,promises;_14e‍.x([["getHeroByIdPromise",()=>getHeroByIdPromise]]);_14e‍.w("./data",[["heroData",["heroData"],function(v){heroData=v}]]);_14e‍.w("dns",[["promises",["promises"],function(v){promises=v}]]);
 ...
 */
       function getHeroByIdPromise(heroData, id) {
...
const hero2 = getHeroByIdPromise(heroData, 2)
  .then(hero => {
    _14e‍.g.console.log(`Found the hero with id ${hero.id}`, hero);
  })
  .catch(error => {
    _14e‍.g.console.log(error);
  });
