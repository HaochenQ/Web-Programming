let heroData;_0bc‍.x([["getHeroByIdCallback",()=>getHeroByIdCallback]]);_0bc‍.w("./data",[["heroData",["heroData"],function(v){heroData=v}]]);
...
getHeroByIdCallback(heroData, 2, (hero) => {
    _0bc‍.g.console.log(`Found the hero with id ${hero.id}`, hero);
});
